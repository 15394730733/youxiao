package com.youxiao.ui.activity.work.stockmanager;
 ...
 * @since 2016-8-6
 */
public class StockOperationActivity extends BaseActivity implements View.OnClickListener,View.OnTouchListener{
    ...
    private LinearLayout mLinearLayout_StockPolicy;
    ...
    public void initView() {
        ...
        mLinearLayout_StockPolicy = (LinearLayout) findViewById(R.id.id_ll_stock_policy);
    }

    @Override
    public void initData() {
        mTextView_Balance.setText("10箱");
    ...
    public void initEvent() {
        ...
        mLinearLayout_StockPolicy.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.id_iv_deposit_operation_switch:
                if (mTextView_Type.getText().toString().equals("存货收入")) {
                    mTextView_Type.setText("存货支出");
                } else {
                    mTextView_Type.setText("存货收入");
                }
                break;
            case R.id.id_ll_stock_policy:
//                intent.setClass(this, PolicyListActivity.class);
