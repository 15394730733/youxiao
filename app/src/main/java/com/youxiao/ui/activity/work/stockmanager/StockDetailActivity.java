...
public class StockDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initData() {
        ...
        mAllAdapter = new CommonAdapter<String>(this, mDatas1, R.layout.item_stock_detail) {
            @Override
        ...
        mCollectionAdapter = new CommonAdapter<String>(this, mDatas, R.layout.item_stock_detail) {
            @Override
            public void convert(final ViewHolder holder, String s) {
        ...
        mDebtAdapter = new CommonAdapter<String>(this, mDatas, R.layout.item_stock_detail_expenditure) {
            @Override
