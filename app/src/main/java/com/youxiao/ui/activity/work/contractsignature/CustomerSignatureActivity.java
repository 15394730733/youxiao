 ...
 * @since 2016-7-29
 */
public class CustomerSignatureActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        mLinearLayout_Back = (LinearLayout) findViewById(R.id.id_ll_customer_signature_back);
        mSignatureView = (SignatureView) findViewById(R.id.id_customer_signature);
        mImageView_SignatureClear = (ImageView) findViewById(R.id.id_iv_customer_signature_clear);
        mImageView_SignatureCommit = (ImageView) findViewById(R.id.id_iv_customer_signature_commit);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.id_ll_customer_signature_back:
                finish();
                break;
            case R.id.id_iv_customer_signature_commit:
                ...
                finish();
                break;
            case R.id.id_iv_customer_signature_clear:
    ...
    private void savePicture(byte[] data) {
        ...
        String fileName = "CS"+GetSystemTime.getTime("yyyyMMdd-HHmmss") + ".jpg";
