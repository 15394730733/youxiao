...
public class StockManagerActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void initData() {
        ...
        mAdapter = new CommonAdapter<String>(this, mDatas, R.layout.item_stock_manager) {
            @Override
                ...
                holder.setViewOnClick(new ViewHolder.ViewClick() {
                    ...
                    public void onClick(View v, int position) {
                        ...
                        if (v.getId() == R.id.id_iv_credit_note_collection) {
                            intent.setClass(StockManagerActivity.this, StockOperationActivity.class);
                        } else if (v.getId() == R.id.id_iv_credit_note_detail) {
                            intent.setClass(StockManagerActivity.this, StockDetailActivity.class);
                        }
