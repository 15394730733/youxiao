...
public class TakePictureActivity extends BaseActivity {
    ...
    public void initView() {
        mTextView_CustomerName = (TextView) findViewById(R.id.id_tv_take_picture_customer_name);
        mSurfaceView_Preview = (SurfaceView) findViewById(R.id.id_sv_take_picture_preview);
...
//        Log.i("size",String.format("size:<%d, %d>", picSize.width, picSize.height));
    ...
    private void savePicture(byte[] data) {
        ...
        String fileNo = switchFileName(TakePictureActivity.this);
        String fileName = fileNo + ".jpg";
     ...
     * @return
     */
    private String switchFileName(Context context) {
