 ...
 * @since 2016-7-28
 */
public class CreditNoteCollectionActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_credit_note_collection);
        super.init();
    ...
    public void initView() {
        ...
        mImageView_CreditNoteDetail = (ImageView) findViewById(R.id.id_iv_credit_note_collection_detail);
    ...
    public void initEvent() {
        mImageView_CreditNoteDetail.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.id_iv_credit_note_collection_detail:
                ...
                intent.setClass(this, CreditNoteDetailActivity.class);
