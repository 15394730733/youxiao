...
import com.youxiao.util.ScreenUtils;
import com.youxiao.widget.Drawl.GestureCallBack;
...
public class ContentView extends ViewGroup {
	...
	public ContentView(Context context,String psd,GestureCallBack callBack) {
		super(context);
		screenDispaly = ScreenUtils.getScreenDispaly(context);
		d = screenDispaly[0]/4;
		this.list = new ArrayList<Point>();
		...
		addChild();
		// 初始化一个可以画线的view
		drawl = new Drawl(context,psd, list,callBack);
		//paint.setStrokeWidth(8);//设置两个点之间的线的北京的宽度
	}
	...
	private void addChild(){
		for (int i = 0; i < 9; i++) {
			...
			Point p = new Point(leftX, rightX, topY, bottomY, image,i);
