 ...
 */
public class SHongSlidingLayout extends ViewGroup {
    ...
    public SHongSlidingLayout(Context context) {
        this(context, null);
    }

    public SHongSlidingLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SHongSlidingLayout(Context context, AttributeSet attrs, int defStyle) {
...
//        }
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(SHongSlidingLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(SHongSlidingLayout parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(SHongSlidingLayout.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(SHongSlidingLayout.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == SHongSlidingLayout.this) {
