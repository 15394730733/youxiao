...
//						break;
//					case 3://跑单列表
//						Intent intentSkipper = new Intent();
//						intentSkipper.setClass(mContext, SkipperActivity.class);
//						mContext.startActivity(intentSkipper);
//						break;
//					case 4://结算
//						if (!"".equals(GLOBAL.VISIT_CUST_ID)) {
//							Intent intentAccount = new Intent(mContext, BalanceActivity.class);
//							Bundle bundle = new Bundle();
//							bundle.putBoolean("isTrue", false);
//							intentAccount.putExtras(bundle);
//							mContext.startActivity(intentAccount);
//						}else {
...
//					textView.setSingleLine(true);
                    convertView = LayoutInflater.from(mContext).inflate(R.layout.title_popup_list, parent, false);
                    holder = new ViewHolder();
                    holder.imageView = (ImageView) convertView.findViewById(R.id.layout_share_img);
                    holder.textView = (TextView) convertView.findViewById(R.id.layout_share_tv);
...
//					textView = (TextView) convertView;
                ...
                holder.imageView.setImageDrawable(mActionItems.get(position).mDrawable);
                holder.textView.setText(mActionItems.get(position).mTitle);
